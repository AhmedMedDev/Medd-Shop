...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		/*custom code[*/
		$data['text_product_quote'] = $this->language->get('text_product_quote');
		/*]*/
		...
		$data['text_footer_setting'] = $this->language->get('text_footer_setting');
        ...
        $data['text_newsletter_subscriber'] =  $this->language->get('text_newsletter_subscriber');
		...
		/*custom code[*/
		$data['product_quote'] = $this->url->link('catalog/product_quote', 'token=' . $this->session->data['token'], 'SSL');
		/*]*/
        ...
        $data['subscriber'] = $this->url->link('common/newsletter', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['footer_setting'] = $this->url->link('setting/footersection', 'token=' . $this->session->data['token'], 'SSL');
