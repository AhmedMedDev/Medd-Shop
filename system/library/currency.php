...
class Currency {
	...
	public function getCurrency() {
		if(isset($this->request->post['token'])){
			return $this->getCurrencyByToken($this->request->post['token']);
		}else{
	...
	public function getCurrentCurrency($currency) {
		return $this->getSymbolLeft($currency);
	}
	...
	public function getCurrencyByToken($token){
		$query = $this->db->query("SELECT `currency` FROM `" . DB_PREFIX . "customer` WHERE `token`='".$token."'");
