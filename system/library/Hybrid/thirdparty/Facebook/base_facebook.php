...
abstract class BaseFacebook
{
  ...
  public function setExtendedAccessToken() {
	...
	return $this->updatedSetExtendedAccessToken();
  ...
  public function updatedSetExtendedAccessToken() {
    try {
      // need to circumvent json_decode by calling _oauthRequest
      // directly, since response isn't JSON format.
      $access_token_response = $this->_oauthRequest(
  ...
  protected function getAccessTokenFromCode($code, $redirect_uri = null) {
	//added on 19th feb 2019  
	return $this->updatedGetAccessTokenFromCode($code, $redirect_uri);  
  ...
  /**
  * Description: This function fixed the "Authentication failed! Facebook returned an invalid user id."
  */
  protected function updatedGetAccessTokenFromCode($code, $redirect_uri = null) {
		if (empty($code)) {
		  return false;
		}
