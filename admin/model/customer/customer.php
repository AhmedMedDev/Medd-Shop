...
class ModelCustomerCustomer extends Model {
	...
	public function approve($customer_id) {
		...
		if ($customer_info) {
			...
			//$mailHelper->sendEmail($customer_info['email'], sprintf($this->language->get('text_approve_subject'), $store_name), '', $message);
			$mailHelper->sendEmail($customer_info['email'], sprintf($this->language->get('text_approve_subject'), $store_name), $message, '');
	...
	public function addTransaction($customer_id, $description = '', $amount = '', $order_id = 0) {
		...
		if ($customer_info) {
			...
			$mailHelper->setSenderName($store_name);
			//$mailHelper->sendEmail($customer_info['email'], sprintf($this->language->get('text_transaction_subject'), $this->config->get('config_name')), '', $message);
			$mailHelper->sendEmail($customer_info['email'], sprintf($this->language->get('text_transaction_subject'), $this->config->get('config_name')), $message);
	...
	public function addReward($customer_id, $description = '', $points = '', $order_id = 0) {
		...
		if ($customer_info) {
			...
			$mailHelper->setSenderName($store_name);
			//$mailHelper->sendEmail($customer_info['email'], sprintf($this->language->get('text_reward_subject'), $store_name), '', $message);
			$mailHelper->sendEmail($customer_info['email'], sprintf($this->language->get('text_reward_subject'), $store_name), $message, '');
