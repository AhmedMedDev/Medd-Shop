...
class ModelCatalogAttribute extends Model {
	public function addAttribute($data) {
		...
		foreach ($data['attribute_description'] as $language_id => $value) {
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "attribute_description SET attribute_id = '" . (int)$attribute_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape(trim($value['name'], ' ')) . "'");
		}
	...
	public function getAttributes($data = array()) {
		...
		if (!empty($data['filter_name'])) {
			$sql .= " AND ad.name LIKE '" . $this->db->escape(trim($data['filter_name'])) . "%'";
		}
