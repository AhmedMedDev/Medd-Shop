		...
		if (isset($data['banner_image'])) {
			foreach ($data['banner_image'] as $banner_image) {
				...
				foreach ($banner_image['banner_image_description'] as $language_id => $banner_image_description) {
					...
					$this->db->query("INSERT INTO " . DB_PREFIX . "banner_image_description SET banner_image_id = '" . (int)$banner_image_id . "', language_id = '" . (int)$language_id . "', banner_id = '" . (int)$banner_id . "', title = '" .  $this->db->escape($banner_image_description['title'])."', entry_heading_h3 = '" .  $this->db->escape($banner_image_description['entry_heading_h3'])."', entry_heading_h2 = '" .  $this->db->escape($banner_image_description['entry_heading_h2'])."', entry_heading_h4 = '" .  $this->db->escape($banner_image_description['entry_heading_h4']). "'");
				}
			}
		}
	...
	public function getBannerImages($banner_id) {
		...
		foreach ($banner_image_query->rows as $banner_image) {
			...
			foreach ($banner_image_description_query->rows as $banner_image_description) {
				...
				'entry_heading_h3' => $banner_image_description['entry_heading_h3'],
				'entry_heading_h2' => $banner_image_description['entry_heading_h2'],
				'entry_heading_h4' => $banner_image_description['entry_heading_h4']
				);
			}
