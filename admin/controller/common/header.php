...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['styles'][] = array( 'href' => 'view/stylesheet/custom-admin.css', 'rel' => 'stylesheet', 'media' => 'screen' );
		$data['styles'][] = array( 'href' => 'https://fonts.googleapis.com/css?family=Lato:400,700italic,700,400italic,900,900italic,300,300italic', 'rel' => 'stylesheet', 'media' => 'screen' );
        ...
        $data['cacheUrl'] = $this->url->link('common/dashboard/cacheClean', 'token=' . $this->session->data['token'], 'SSL');
		...
		/****** Message System Ends *****/			
            ...
            if($this->config->get('config_admin_logo') != '') {
                //$data['admin_logo'] = $this->model_tool_image->resize($this->config->get('config_admin_logo'), 121, 32);  
