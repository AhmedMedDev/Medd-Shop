...
class ControllerDesignBanner extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_heading_h3'] = $this->language->get('entry_heading_h3');
		$data['entry_heading_h2'] = $this->language->get('entry_heading_h2');
		$data['entry_heading_h4'] = $this->language->get('entry_heading_h4');
