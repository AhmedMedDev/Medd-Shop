...
class ControllerMessageMessage extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->get['customer_id']) && $this->validateDelete()) {
			$this->model_message_message->deleteCustomerMessages($this->request->get['customer_id']);
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['customers'][] = array(
				...
				'delete'           => $this->url->link('message/message/delete', 'token=' . $this->session->data['token'] . '&customer_id=' . $result['customer_id'] . $url, 'SSL'),
			);
		}
