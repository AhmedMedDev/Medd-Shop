...
class ControllerModuleSlideshow extends Controller {
	...
	public function index() {
		...
		$data['text_slider_type'] = $this->language->get('text_slider_type');
		$data['text_slider_boxed'] = $this->language->get('text_slider_boxed');
		$data['text_slider_full'] = $this->language->get('text_slider_full');
		$data['text_slider_default'] = $this->language->get('text_slider_default');
	...
	protected function validate() {
		...
		if (isset($this->request->post['slider_type']) && $this->request->post['slider_type']=='') {
