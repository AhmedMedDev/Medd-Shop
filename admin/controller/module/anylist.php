...
class ControllerModuleAnylist extends Controller {
	...
	public function index() {   
		...
		$data['entry_template_default'] 			= $this->language->get('entry_template_default');
		$data['entry_template_new_products'] 		= $this->language->get('entry_template_new_products');
		$data['entry_template_products_offers'] 	= $this->language->get('entry_template_products_offers');
		...
		$data['template'] = (isset($module_info['template'])) ? $module_info['template'] : '';
