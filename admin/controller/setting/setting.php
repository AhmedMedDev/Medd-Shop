...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['admin_user_group'] = 0;
		$user_info = $this->model_user_user->getUser($this->user->getId());
		if ($user_info) {
			$data['admin_user_group_id'] = $user_info['user_group_id'] ;
		}

		$data['main_site_url'] = $this->config->get('config_url');

		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {

			if (!isset($this->request->post['config_auto_restore'])) {
				$this->request->post['config_auto_restore'] = $this->config->get('config_auto_restore');
			}
		...
		$data['text_tls'] = $this->language->get('text_tls');
		...
		$data['entry_social_code'] = $this->language->get('entry_social_code');
		...
		$data['entry_auto_restore'] = $this->language->get('entry_auto_restore');
		...
		$data['entry_allow_return_status'] = $this->language->get('entry_allow_return_status');
		...
		$data['entry_admin_login_logo'] = $this->language->get('entry_admin_login_logo');        
		$data['entry_logo_mobile'] = $this->language->get('entry_logo_mobile');
		...
		$data['entry_mail_smtp_secure'] = $this->language->get('entry_mail_smtp_secure');
		...
		$data['entry_demo_store_message'] = $this->language->get('entry_demo_store_message');
		...
		$data['help_allow_return_status'] = $this->language->get('help_allow_return_status');
		...
		$data['help_mail_secure'] = $this->language->get('help_mail_secure');
		...
		if (isset($this->error['auto_restore'])) {
			$data['error_auto_restore'] = $this->error['auto_restore'];
		} else {
			$data['error_auto_restore'] = '';
		}
		...
		if (isset($this->error['allow_return_status'])) {
			$data['error_allow_return_status'] = $this->error['allow_return_status'];
		} else {
			$data['error_allow_return_status'] = '';
		}
		...
		if (isset($this->request->post['config_social_code'])) {
			$data['config_social_code'] = $this->request->post['config_social_code'];
		} else {
			$data['config_social_code'] = $this->config->get('config_social_code');
		}
		...
		if (isset($this->request->post['config_demo_store'])) {
			$data['config_demo_store'] = $this->request->post['config_demo_store'];
		} else {
			$data['config_demo_store'] = $this->config->get('config_demo_store');
		}
		...
		if (isset($this->request->post['config_auto_restore'])) {
			$data['config_auto_restore'] = $this->request->post['config_auto_restore'];
		} else {
			$data['config_auto_restore'] = $this->config->get('config_auto_restore');
		}
		...
		if (isset($this->request->post['config_allow_return_status'])) {
			$data['config_allow_return_status'] = $this->request->post['config_allow_return_status'];
		} elseif ($this->config->get('config_allow_return_status')) {
			$data['config_allow_return_status'] = $this->config->get('config_allow_return_status');
		} else {
			$data['config_allow_return_status'] = array();
		}
        ...
        if (isset($this->request->post['config_admin_login_logo'])) {
			$data['config_admin_login_logo'] = $this->request->post['config_admin_login_logo'];
		} else {
			$data['config_admin_login_logo'] = $this->config->get('config_admin_login_logo');
		}

		if (isset($this->request->post['config_logo_mobile'])) {
			$data['config_logo_mobile'] = $this->request->post['config_logo_mobile'];
		} else {
			$data['config_logo_mobile'] = $this->config->get('config_logo_mobile');
		}
        ...
        if (isset($this->request->post['config_admin_login_logo']) && is_file(DIR_IMAGE . $this->request->post['config_admin_login_logo'])) {
			$data['admin_login_logo'] = $this->model_tool_image->resize($this->request->post['config_admin_login_logo'], 100, 100);
		} elseif ($this->config->get('config_admin_login_logo') && is_file(DIR_IMAGE . $this->config->get('config_admin_login_logo'))) {
			$data['admin_login_logo'] = $this->model_tool_image->resize($this->config->get('config_admin_login_logo'), 100, 100);
		} else {
			$data['admin_login_logo'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}


		if (isset($this->request->post['config_logo_mobile']) && is_file(DIR_IMAGE . $this->request->post['config_logo_mobile'])) {
			$data['logo_mobile'] = $this->model_tool_image->resize($this->request->post['config_logo_mobile'], 100, 100);
		} elseif ($this->config->get('config_logo_mobile') && is_file(DIR_IMAGE . $this->config->get('config_logo_mobile'))) {
			$data['logo_mobile'] = $this->model_tool_image->resize($this->config->get('config_logo_mobile'), 100, 100);
		} else {
			$data['logo_mobile'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		if (isset($this->request->post['config_mail_secure'])) {
			$data['config_mail_secure'] = $this->request->post['config_mail_secure'];
		} else {
			$data['config_mail_secure'] = $this->config->get('config_mail_secure');
		}
	...
	protected function validate() {
		...
		if (!isset($this->request->post['config_allow_return_status'])) {
			$this->error['allow_return_status'] = $this->language->get('error_allow_return_status');
		}
