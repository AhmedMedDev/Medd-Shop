...
<div id="content">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <?php  /* if(isset($admin_user_group_id) && $admin_user_group_id==1){	?>
                            <div class="form-group required" style="display:none;">
                                <strong style="color:red;">Generate New Restore Point before turning it <span style="color:green;">On:-</span> <a href="<?php echo $main_site_url; ?>/index.php?route=common/cron_setting/create_restore"
                                        target="_blank">Create New Restore</a></strong>
                            </div>
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-meta-title"><?php echo $entry_auto_restore; ?></label>
                                <div class="col-sm-10">
                                    <select name="config_auto_restore" id="config_auto_restore" class="form-control">
                                        <option value="1" <?php if($config_auto_restore==1) echo 'selected="selected" ';?>>On</option>
                                        <option value="0" <?php if($config_auto_restore==0) echo 'selected="selected" ';?>>Off</option>
                                    </select>
                                    <?php if ($error_auto_restore) { ?>
                                    <div class="text-danger"><?php echo $error_auto_restore; ?></div>
                                    <?php } ?>
                                </div>
                            </div>
                            <?php }	 */ ?>
                        ...
                        <div class="tab-pane" id="tab-store">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-google-map"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_google_map; ?>"><?php echo $entry_google_map; ?></span></label>
                                <div class="col-sm-10">
                                    <textarea name="config_google_map" placeholder="<?php echo $entry_google_map; ?>" id="input-google-map" class="form-control"><?php echo $config_google_map; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-contact-email"><span data-toggle="tooltip" data-container="#tab-general" title="<?php echo $help_contact_email; ?>"><?php echo $entry_contact_email; ?></span></label>
                                <div class="col-sm-10">
                                    <textarea name="config_contact_email" placeholder="<?php echo $entry_contact_email; ?>" id="input-contact-email" class="form-control"><?php echo $config_contact_email; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-social-code"><?php echo $entry_social_code; ?></label>
                                <div class="col-sm-10">
                                    <textarea name="config_social_code" placeholder="<?php echo $entry_social_code; ?>" id="input-social-code" class="form-control"><?php echo $config_social_code; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group required">
			  ...
			  foreach ($languages as $language) {
				$icount++;
			  ?>
                                <li <?php echo ($icount==0) ? 'class="active"': ''; ?>>
				...
				$icount++;
				?>
                                <div class="tab-pane  <?php echo ($icount==0) ? 'active': ''; ?>" id="language<?php echo $language['language_id']; ?>">
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label"><?php echo $entry_status; ?></label>
                                        <div class="col-sm-10">
                                            <input type="radio" name="config_demo_store[<?php echo $language['language_id']; ?>][status]" value="1"
                                                <?php echo isset($config_demo_store[$language['language_id']]['status']) && ($config_demo_store[$language['language_id']]['status']==1) ? 'checked' : ''?> /> On
                                            <input type="radio" name="config_demo_store[<?php echo $language['language_id']; ?>][status]" value="0"
                                                <?php echo isset($config_demo_store[$language['language_id']]['status']) && ($config_demo_store[$language['language_id']]['status']==0) ? 'checked' : ''?> /> Off
                                        </div>
                                    </div>
                                    <div class="form-group required">
                                        <label class="col-sm-2 control-label"><?php echo $entry_demo_store_message; ?></label>
                                        <div class="col-sm-10">
                                            <input type="text" name="config_demo_store[<?php echo $language['language_id']; ?>][message]"
                                                value="<?php echo isset($config_demo_store[$language['language_id']]['message']) ? $config_demo_store[$language['language_id']]['message'] : ''; ?>" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
                        ...
                        <div class="tab-pane" id="tab-option">
                            <fieldset>
                                ...
                                <div class="form-group required">
                                    <label class="col-sm-2 control-label" for="input-list-description-limit"><span data-toggle="tooltip"
                                            title="<?php echo $help_product_description_length; ?>"><?php echo $entry_product_description_length; ?></span></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="config_product_description_length" value="<?php echo $config_product_description_length; ?>" placeholder="<?php echo $entry_product_description_length; ?>"
                                            id="input-list-description-limit" class="form-control" />
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-process-status"><span data-toggle="tooltip" title="<?php echo $help_allow_return_status; ?>"><?php echo $entry_allow_return_status; ?></span></label>
                                    <div class="col-sm-10">
                                        <div class="well well-sm" style="height: 150px; overflow: auto;">
                                            <?php foreach ($order_statuses as $order_status) { ?>
                                            <div class="checkbox">
                                                <label>
                                                    <?php if (in_array($order_status['order_status_id'], $config_allow_return_status)) { ?>
                                                    <input type="checkbox" name="config_allow_return_status[]" value="<?php echo $order_status['order_status_id']; ?>" checked="checked" />
                                                    <?php echo $order_status['name']; ?>
                                                    <?php } else { ?>
                                                    <input type="checkbox" name="config_allow_return_status[]" value="<?php echo $order_status['order_status_id']; ?>" />
                                                    <?php echo $order_status['name']; ?>
                                                    <?php } ?>
                                                </label>
                                            </div>
                                        ...
                                        <?php if ($error_allow_return_status) { ?>
                                        <div class="text-danger"><?php echo $error_allow_return_status; ?></div>
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="config_affiliate_commission" value="<?php echo $config_affiliate_commission; ?>" placeholder="<?php echo $entry_affiliate_commission; ?>" id="input-affiliate-commission"
                                            class="form-control" />
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="tab-pane" id="tab-image">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-logo"><span data-toggle="tooltip" title="Recommended Image- 16:9"><?php echo $entry_logo; ?></span></label>
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-admin-logo"><span data-toggle="tooltip" title="Recommended Image- 121 * 32 px"><?php echo $entry_admin_logo; ?></span></label>
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-admin-login-logo"><span data-toggle="tooltip" title="Recommended Image- 213 * 57 px"><?php echo $entry_admin_login_logo; ?></span></label>
                                <div class="col-sm-10"><a href="" id="thumb-admin-login-logo" data-toggle="image" class="img-thumbnail"><img src="<?php echo $admin_login_logo; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                  <input type="hidden" name="config_admin_login_logo" value="<?php echo $config_admin_login_logo; ?>" id="input-admin-login-logo" />
                                </div>
                             </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-logo-mobile"><span data-toggle="tooltip" title="Recommended Image- 1:1"><?php echo $entry_logo_mobile; ?></span></label>
                                <div class="col-sm-10"><a href="" id="thumb-logo-mobile" data-toggle="image" class="img-thumbnail"><img src="<?php echo $logo_mobile; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                                    <input type="hidden" name="config_logo_mobile" value="<?php echo $config_logo_mobile; ?>" id="input-logo-mobile" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <input type="text" name="config_image_additional_width" value="<?php echo $config_image_additional_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-image-additional-width"
                                                class="form-control" />
                                        </div>
                                        <div class="col-sm-6">
                        ...
                        <div class="tab-pane" id="tab-mail">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-mail-secure"><span data-toggle="tooltip" title="<?php echo $help_mail_secure; ?>"><?php echo $entry_mail_smtp_secure; ?></span></label>
                                <div class="col-sm-10">
                                    <select name="config_mail_secure" id="input-mail-secure" class="form-control">
                                        <?php if ($config_mail_secure == 'ssl') { ?>
                                        <option value="ssl" selected="selected"><?php echo $text_ssl; ?></option>
                                        <?php } else { ?>
                                        <option value="ssl"><?php echo $text_ssl; ?></option>
                                        <?php } ?>
                                        <?php if ($config_mail_secure == 'tls') { ?>
                                        <option value="tls" selected="selected"><?php echo $text_tls; ?></option>
                                        <?php } else { ?>
                                        <option value="tls"><?php echo $text_tls; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $('#input-social-code, #input-contact-email, #input-google-map').summernote({
            height: 200
        });
        //-->
    </script>
