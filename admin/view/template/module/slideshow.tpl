    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
		  ...
		  <div class="form-group">
            <label class="col-sm-2 control-label" for="input-slider-type"><?php echo $text_slider_type; ?></label>
            <div class="col-sm-10">
			<select name="slider_type" class="form-control">
              <option value=""  <?php echo (isset($slider_type) && $slider_type =="") ? 'selected': ''; ?>><?php echo $text_slider_default; ?></option>
              <option value="slider-one"  <?php echo (isset($slider_type) && $slider_type =="slider-one") ? 'selected': ''; ?>><?php echo $text_slider_full; ?></option>
              <option value="slider-two" <?php echo (isset($slider_type) && $slider_type =="slider-two") ? 'selected': ''; ?>><?php echo $text_slider_boxed; ?></option>
			</select>
            </div>
          </div>
          <div class="form-group">
