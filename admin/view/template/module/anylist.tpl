      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-latest" class="form-horizontal">
          ...
          <div class="form-group">
			 ...
			 <div class="form-group">
            	<label class="col-sm-2 control-label" for="status"><?php echo $text_template; ?></label>
        		<div class="col-sm-10">
	                <select class="form-control" name="template" id="template">
	                  <option <?php echo ($template=='') ? 'selected="selected"' : ''; ?> value=""><?php echo $entry_template_default; ?></option>
	                  <option <?php echo ($template=='anylist_new_products') ? 'selected="selected"' : ''; ?> value="anylist_new_products"><?php echo $entry_template_new_products; ?></option>
	                  <option <?php echo ($template=='anylist_product_offers') ? 'selected="selected"' : ''; ?> value="anylist_product_offers"><?php echo $entry_template_products_offers; ?></option>
	                </select>
          		</div>
		  </div> 
