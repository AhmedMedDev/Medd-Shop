          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left"><?php echo $entry_heading_h3; ?></td>
                <td class="text-left"><?php echo $entry_heading_h2; ?></td>
                <td class="text-left"><?php echo $entry_heading_h4; ?></td>
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
				...
				<td class="text-left" style="width: 15%;">
					...
					<input type="text" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][entry_heading_h3]" value="<?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['entry_heading_h3'] : ''; ?>" placeholder="<?php echo $entry_heading_h3; ?>" class="form-control" />
					<?php } ?>
				</td>
				<td class="text-left" style="width: 15%;">
					<?php foreach ($languages as $language) { ?>
					<input type="text" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][entry_heading_h2]" value="<?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['entry_heading_h2'] : ''; ?>" placeholder="<?php echo $entry_heading_h2; ?>" class="form-control" />
					<?php } ?>
				</td>
				<td class="text-left" style="width: 15%;">
					<?php foreach ($languages as $language) { ?>
					<input type="text" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][entry_heading_h4]" value="<?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['entry_heading_h4'] : ''; ?>" placeholder="<?php echo $entry_heading_h4; ?>" class="form-control" />
					<?php } ?>
				</td>
...
function addImage() {
	...
	html +='<td class="text-left" style="width: 15%;">';
	<?php foreach ($languages as $language) { ?>
	html += '<input type="text" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][entry_heading_h3]" value="<?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['entry_heading_h3'] : ''; ?>" class="form-control" />';
	<?php } ?>
	html +='</td>';
	
	html +='<td class="text-left" style="width: 15%;">';
	<?php foreach ($languages as $language) { ?>
	html +='<input type="text" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][entry_heading_h2]" value="<?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['entry_heading_h2'] : ''; ?>" class="form-control" />';
	<?php } ?>
	html +='</td>';
	
	html +='<td class="text-left" style="width: 15%;">';
	<?php foreach ($languages as $language) { ?>
	html +='<input type="text" name="banner_image[<?php echo $image_row; ?>][banner_image_description][<?php echo $language['language_id']; ?>][entry_heading_h4]" value="<?php echo isset($banner_image['banner_image_description'][$language['language_id']]) ? $banner_image['banner_image_description'][$language['language_id']]['entry_heading_h4'] : ''; ?>" class="form-control" />';
	<?php } ?>
	html +='</td>';
