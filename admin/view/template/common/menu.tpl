<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-tags fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
	  ...
	  <?php /*custom code[*/ ?>
      <li><a href="<?php echo $product_quote; ?>"><?php echo $text_product_quote; ?></a></li>
	  <?php /*]*/ ?>
    </ul>
  </li>
  ...
  <li id="customer"><a class="parent"><i class="fa fa-user fa-fw"></i> <span><?php echo $text_customer; ?></span></a>
    <ul>
      ...
      <?php /*<li><a href="<?php echo $custom_field; ?>"><?php echo $text_custom_field; ?></a></li>*/ ?>
    </ul>
  </li>
  <li><a class="parent"><i class="fa fa-share-alt fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $subscriber; ?>"><?php echo $text_newsletter_subscriber; ?></a></li>
  ...
  <li id="system"><a class="parent"><i class="fa fa-cog fa-fw"></i> <span><?php echo $text_system; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $footer_setting; ?>"><?php echo $text_footer_setting; ?></a></li>
