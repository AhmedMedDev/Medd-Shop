...
<script type="text/javascript" src="view/javascript/jquery/custom.js"></script>
<script type="text/javascript" src="view/javascript/bootstrap/js/bootstrap.min.js"></script>
<link href="view/stylesheet/bootstrap.css" type="text/css" rel="stylesheet" />
<link href="view/stylesheet/timeslot.css" type="text/css" rel="stylesheet" />
    ...
    <header id="header" class="navbar navbar-static-top">
      <div class="navbar-header">
        ...
        <a href="<?php echo $home; ?>" class="navbar-brand">
            <?php
                if($admin_logo) { ?>
                     <img src="<?php echo $server.'image/'.$admin_logo;?>" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" width="121" height="32" />
               <?php  }
                else { ?>
      ...
      <ul class="nav pull-right">
         <li>
			<a href="<?php echo $cacheUrl;?>" title="<?php echo $text_cache_clear;?>">				
