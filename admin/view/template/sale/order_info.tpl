      ...
      <div class="col-md-4">
        <div class="panel panel-default">
          ...
          <table class="table">
			...
			<tr>
                <td><button data-toggle="tooltip" title="Delivery Date and Time" class="btn btn-info btn-xs"><i class="fa fa-truck fa-fw"></i></button></td>
                <td><strong><?php echo $delivery_time; ?></strong></td>			
			</tr>
			<?php } ?>				  
