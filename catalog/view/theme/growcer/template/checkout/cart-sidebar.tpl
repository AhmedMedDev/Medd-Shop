                  ...
                  <div class="productBox">
                    ...
                    <div class="desc-wrap">
					  ...
					  <div class="quantity"><?php echo $column_quantity; ?>:
						...
						<button type="submit" title="<?php echo $button_update; ?>" class="themeBtn"><?php echo $button_update; ?></button>						
					</div>
	 ...
	 xml:space="preserve">
            ...
            <div class="cart-tabs">
              <ul class="tabs">			  
				...
				<?php } ?>
				<?php if($reward){ ?>
                <li><a href="<?php echo $current_page_url ?>#tab3" class="ripple"><?php echo $entry_rewards; ?></a></li>
				<?php } ?>
				<?php if($shipping){ ?>
          ...
          <div class="col-md-3">
            <div class="right-wrap">
              ...
              <div class="place-order-wraper clearfix">
