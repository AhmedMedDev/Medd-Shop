			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="right-wrap">
					  <div class="backto clearfix"> <a tabindex="0" class="addtocart-btn green small <?php echo $hide_Data; ?>" href="<?php echo $continue; ?>"><?php echo $button_shopping; ?><span class="cartIcon">
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            if (json['redirect']) {
                ...
                if (json['error']['warning']) {
                    $('#collapse-shipping-method .checkout-content-body').prepend('<div class="alert alert-warning">' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert"></button></div><div class="alert-after"></div>');
                }
            } else {
