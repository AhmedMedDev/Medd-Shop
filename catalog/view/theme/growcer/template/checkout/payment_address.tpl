<form class="siteForm form-horizontal">
	<legend><?php echo ($text_checkout_payment_address) ? $text_checkout_payment_address : ''; ?></legend>
	<?php if ($addresses) { ?>
	...
	<div id="payment-existing">
		...
		<div class="address-bar">
			<ul>
				...
				<?php } ?>
				<li class="add-new">
					<a href="javascript:void(0)" id="new_payment_address">
	...
	<div>
		<div id="payment-new" style="display: <?php echo ($addresses) ? 'none' : 'block'; ?>;">
			...
			<div class="radio-wrap">
				<label class="radio">
					<input type="radio" name="existing_payment_address" value="existing" />
			...
			<div class="form-group required">
				<div class="col-md-6">
					...
					<input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="form-control text-input" />
				</div>
				<div class="col-md-6">
			...
			<div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
				<label class="col-md-2 control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
				<div class="col-md-10">
			...
			<div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
				<label class="col-md-2 control-label"><?php echo $custom_field['name']; ?></label>
				<div class="col-md-10">
			...
			<div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
				<label class="col-md-2 control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
				<div class="col-md-10">
					<textarea name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"
			...
			<div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
				<label class="col-md-2 control-label"><?php echo $custom_field['name']; ?></label>
				<div class="col-md-10">
					<button type="button" id="button-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-default"><i class="fa fa-upload"></i>
		...
		<div class="buttons clearfix">
			<div class="pull-right">
				...
				<?php } ?>
				<input type="button" value="<?php echo $button_continue; ?>" id="button-payment-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary themeBtn" />
			</div>
		</div>
	</div>
</form>
<script type="text/javascript">
	<!--
	$('input[name=\'existing_payment_address\']').on('change', function() {
		if (this.value == 'existing') {
			$('input[name=payment_address]').attr('value', 'existing');
			$('#payment-existing').show();
			$('#payment-new').hide();
		}
	});
	$('#new_payment_address').on('click', function() {
		$('input[name=payment_address]').attr('value', 'new');
		$('input[name=existing_payment_address]').removeAttr('checked');
