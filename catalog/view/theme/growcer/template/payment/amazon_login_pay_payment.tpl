...
<div class="container"><?php echo $content_top; ?>
	<div style="text-align:center;">
        ...
        <div class="buttons">
		 <div class="gap"></div>
            <div class="pull-left">
                <a href="<?php echo $back; ?>" class="btn btn-primary themeBtn"><?php echo $text_back; ?></a>
            </div>
            <div class="pull-right">
                <input class="btn btn-primary themeBtn" id="continue-button" type="submit" value="<?php echo $text_continue; ?>" />
            </div>
        </div>
