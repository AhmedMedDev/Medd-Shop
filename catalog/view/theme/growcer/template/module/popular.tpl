                                ...
                                <div class="productBox">
                                    <div class="imgBlock">
                                        <div class="productImg">
                                            <a href="<?php echo $first_pro['href']; ?>">
                                                <?php if(isset($first_pro['thumb']) && $first_pro['thumb']!=''){ ?>
                                                <img src="<?php echo $first_pro['thumb']; ?>" class="img-effects img-responsive" alt="<?php echo $first_pro['name']; ?>" title="<?php echo $first_pro['name']; ?>" />
                                                <?php }else{ ?>
                                                <img src="catalog/view/theme/growcer/images/placeholder.png" alt="<?php echo $first_pro['name']; ?>" title="<?php echo $first_pro['name']; ?>" class="img-effects img-responsive" />
                                                <?php } ?>
                                            </a>
                                        </div>
                                        <div class="actionBtn">
                                            <a href="javascript:void(0)" class="squrBtn zoom-icon" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $first_pro['product_id']; ?>');">
                                            ...
                                            <a href="javascript:void(0)" class="squrBtn fav-icon" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $first_pro['product_id']; ?>');">
                                    ...
                                    <div class="infoBlock align-center">
                                        <h2 class="title-name" title="<?php echo $first_pro['name']; ?>"><a
                                                href="<?php echo $first_pro['href']; ?>"><?php echo (strlen($first_pro['name'])>18) ? substr($first_pro['name'], 0, 18).'...' : $first_pro['name']; ?></a></h2>
                                        <div class="rating">
                                            <?php
							if ($first_pro['rating']) { ?>
                                            <ul>
									...
									if($first_pro['rating']>=$i) { $class='active'; } else{$class='in-active';}; ?>
                                        ...
                                        <?php } ?>
                                        <button type="button" class="themeBtn" onclick="cart.add('<?php echo $first_pro['product_id']; ?>');"><span class="txt"><?php echo $button_cart; ?></span> <i class="cartIcon">
...
C339.433,422.431,356.15,438.298,376.267,438.298z" />
						...
						foreach ($products as $product) { ?>
                                            <div class="box"> <a href="<?php echo $product['href']; ?>" class="detail-box clearfix">
                                                    ...
                                                    <div class="grid">
                                                        <div class="infoBlock">
                                                            <h2 class="title-name" title="<?php echo $product['name']; ?>"><?php echo (strlen($product['name'])>25) ? substr($product['name'], 0, 25).'...' : $product['name']; ?></h2>
