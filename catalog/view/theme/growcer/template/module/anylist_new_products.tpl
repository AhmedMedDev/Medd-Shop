                  ...
                  <div class="grid pull_left right-border">
                    <div class="productBox">
                        ...
                        <div class="productImg">
							<a href="<?php echo $first_pro['href']; ?>">	  
								<?php if(isset($first_pro['thumb']) && $first_pro['thumb']!=''){ ?>
									<img src="<?php echo $first_pro['thumb']; ?>" alt="<?php echo $first_pro['name']; ?>" title="<?php echo $first_pro['name']; ?>" class="img-effects img-responsive" />
								<?php }else{ ?>
                      ...
                      <div class="infoBlock align-center">
                        <h2 class="title-name"><a href="<?php echo $first_pro['href']; ?>" title="<?php echo $first_pro['name']; ?>"><?php echo (strlen($first_pro['name'])>40) ? substr($first_pro['name'], 0, 40).'...' : $first_pro['name']; ?></a></h2>
                        <div class="rating">
                      ...
                      <div class="prduct-sldr">
						...
						foreach ($products as $product) { ?>
                          <div class="box"> <a href="<?php echo $product['href']; ?>" class="detail-box clearfix">
                            ...
                            <div class="grid">
                              <div class="infoBlock">
                                <h2 class="title-name" title="<?php echo $product['name']; ?>"><?php echo (strlen($product['name'])>15) ? substr($product['name'], 0, 15).'...' : $product['name']; ?></h2>
