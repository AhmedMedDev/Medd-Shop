			...
			<div class="row">
				...
				<div class="col-md-9 column">
					<div class="dash-page-content">
						...
						<!--ul class="tabs"-->
						<a href="javascript:void(0);" class="toggle-account-nav"><?php echo $nav_text_download; ?><span class="tantoo"></span></a>
						<ul>
						  ...
						  <li class="active"><a data-for="#download" href="<?php echo $download; ?>" onclick="changeUrl(this)" class="ripple" title="<?php echo $help_text_download; ?>"><?php echo $nav_text_download; ?></a></li>
						  <?php if($reward){ ?>
					...
					<section class="account_content">
						 ...
						 <!--div class="tab_content" id="download"-->
						 <div id="download">
