			...
			<div class="row">
				...
				<div class="col-md-9 column">
					...
					<div class="account-nav">
						<!--ul class="tabs"-->
						<a href="javascript:void(0);" class="toggle-account-nav"><?php echo $nav_text_reward; ?><span class="tantoo"></span></a>
						<ul>
						  ...
						  <?php if($reward){ ?>
						  <li class="active"><a data-for="#reward" href="<?php echo $reward; ?>" onclick="changeUrl(this)" class="ripple" title="<?php echo $help_text_reward; ?>"><?php echo $nav_text_reward; ?></a></li>
						  <?php } ?>
					...
					<section class="account_content">
						...
						<div id="download"></div>
						<!--div class="tab_content" id="reward"-->
						<div id="reward">
							<div class="heading">
