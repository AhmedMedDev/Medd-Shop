...
<div class="buttons">
  <div class="pull-right a">
	...
	<a href="index.php?route=account/wallet" class="btn btn-primary themeBtn">Back</a>
	
    <input type="button" value="<?php echo $button_continue; ?>" id="button-wallet-payment-method" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary themeBtn" />
  </div>
</div>
</fieldset>
<?php } else { ?>
