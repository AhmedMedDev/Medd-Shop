			...
			<div class="row">
				...
				<div class="col-md-9 column">
					<div class="dash-page-content">
						...
						<!--ul class="tabs"-->
						<a href="javascript:void(0);" class="toggle-account-nav"><?php echo $help_text_recurring; ?><span class="tantoo"></span></a>
						<ul>
						  ...
						  <li class="active"><a  data-for="#recurring" href="<?php echo $recurring; ?>" onclick="changeUrl(this)" class="ripple" title="<?php echo $help_text_recurring; ?>"><?php echo $nav_text_recurring; ?></a></li>
						</ul>
					</div>
							...
							<table class="tbl-normal tbl-responsive">
							  ...
							  <tbody>
								...
								<?php foreach ($recurrings as $recurring) { ?>
								 <tr>
									<td>#<?php echo $recurring['id']; ?></td>
									<td><?php echo $recurring['date_added']; ?></td>
									<td><?php echo $status_types[$recurring['status']]; ?></td>
									<td><?php echo $recurring['name']; ?></td>
									<td><a href="<?php echo $recurring['href']; ?>" class="btn btn-info"><?php echo $button_view; ?></a></td>
								  </tr>
								<?php } ?>
								<?php } else { ?>
									<tr>
