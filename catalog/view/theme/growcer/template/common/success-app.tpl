      ...
      <div class="fix-container">
        <div class="row">		
			<div class="col-md-12">
                ...
                <!-- For identify its for redirecting from success page to mobile app.-->
				<a href="mobile_app.html" class="themeBtn abc <?php echo $hide_Data; ?>"><?php echo $button_continue; ?></a>
				</div>
			</div>
        </div>
      </div>
