...
<div id="body">
	...
	<div class="main-area">
		<div class="fix-container">
			...
			<div class="heading"><?php echo $heading_title; ?></div><?php /* <?php echo $entry_search; ?> */ ?>
			<form class="form-horizontal siteForm" id="searchForm" enctype="multipart/form-data" method="post">
				<fieldset>
							...
							<ul class="radio-wrap">
								<li>
									<label class="checkbox">
										...
										<?php } ?>
										<i class="input-helper"></i><?php echo $text_sub_category; ?>
									</label>
								</li>
								<li>
									<label class="checkbox">
										...
										<?php } ?>
										<i class="input-helper"></i><?php echo $entry_description; ?>
									</label>
								</li>
							</ul>
						</div>
							...
							<li>
								<div class="productBox">
									...
									<div class="infoBlock">
										<?php
								/**
								<h2 class="title-name"><a href="<?php echo $product['href']; ?>"><?php echo (strlen($product['name'])>15) ? substr($product['name'], 0, 15).'...' : $product['name']; ?></a></h2>
										**/ ?>
