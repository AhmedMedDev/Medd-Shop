		...
		<div class="fix-container">
			...
			<div class="row">
				<div class="col-md-12 column">
					<div class="row">
					  <div class="col-md-12">
						<div class="heading"><div class="heading"><?php echo $heading_title; ?></div></div>
					  </div>
					</div>
					  <?php if ($categories) { ?>
							...
							<div class="category-box">
							  ...
							  <a href="<?php echo $category['href']; ?>">
								<?php if(isset($category['image']) && trim($category['image'])!=''){ ?>
									<img alt="Category Image" class="img-effects" src="image/<?php echo $category['image']; ?>">
								<?php }else{ ?>
									<img alt="Placeholder" class="img-effects" src="catalog/view/theme/growcer/images/placeholder.png">
								<?php } ?>
							  </a></div>
					...
					<div class="gap"></div>
					<div class="row">
						<div class="col-md-12 column ddd">
							<?php if($products){ ?>
							...
							<div class="head-bar">
							   <div class="pull_left">
								...
								<span class="s-by"><form class="siteForm">
...
function display(view) {
	if (view == 'list') {
		if($('.productsListing').hasClass('list-view')){}
		else{
		...
		if($('.productsListing').hasClass('boxes-4')){}
		else{
