...
<li>
	<div class="productBox">
		<div class="imgBlock">
			...
			<div class="actionBtn">
				...
				<a href="javascript:void(0)" class="squrBtn fav-icon" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');">
					<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="369.486px" height="369.486px" viewBox="0 0 369.486 369.486" style="enable-background:new 0 0 369.486 369.486;"
						xml:space="preserve">
						<g>
							<g>
		...
		<?php if(isset($display_view) && $display_view=='grid-view'){ ?>
		<div class="infoBlock">
			...
			**/ ?>
			...
			<h2 class="title-name" title="<?php echo $product['name']; ?>"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h2>
		...
		<?php }
							  else if(isset($display_view) && $display_view=='list-view'){ ?>
		<div class="desc-wrap">
