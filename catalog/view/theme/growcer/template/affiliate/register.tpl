      ...
      <div class="fix-container">
        ...
        <div class="row">
			...
			<?php echo $content_top; ?>
			  ...
			  <p class="sub-heading"><?php echo $text_account_already; ?></p>
			  <p class="sub-heading"><?php echo $text_signup; ?></p>
			  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal siteForm no-left-right-margin">
				...
				<fieldset>
				  ...
				  <div class="form-group required">
					...
					<div class="col-md-9">
					  <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-postcode" class="form-control" required="required"  />
				...
				<fieldset>
				  ...
				  <div class="form-group">
					<label class="col-md-3 control-label" for="input-tax"><?php echo $entry_tax; ?></label>
					<div class="col-md-9">
					  <input type="text" name="tax" value="<?php echo $tax; ?>" placeholder="<?php echo $entry_tax; ?>" id="input-tax" class="form-control" />
					</div>
				  </div>
				  <div class="form-group">
					<label class="col-md-3 control-label"><?php echo $entry_payment; ?></label>
					<div class="col-sm-9">
						<ul class="radio-wrap">
						  <li>
							<label class="radio">
				  ...
				  <div class="form-group payment" id="payment-cheque">
					<label class="col-md-3 control-label" for="input-cheque"><?php echo $entry_cheque; ?></label>
					<div class="col-md-9">
				  ...
				  <div class="form-group payment" id="payment-paypal">
					<label class="col-md-3 control-label" for="input-paypal"><?php echo $entry_paypal; ?></label>
					<div class="col-md-9">
				  ...
				  <div class="payment" id="payment-bank">
					<div class="form-group">
					  <label class="col-md-3 control-label" for="input-bank-name"><?php echo $entry_bank_name; ?></label>
					  <div class="col-md-9">
					...
					<div class="form-group">
					  <label class="col-md-3 control-label" for="input-bank-branch-number"><?php echo $entry_bank_branch_number; ?></label>
					  <div class="col-md-9">
					...
					<div class="form-group">
					  <label class="col-md-3 control-label" for="input-bank-swift-code"><?php echo $entry_bank_swift_code; ?></label>
					  <div class="col-md-9">
					...
					<div class="form-group">
					  <label class="col-md-3 control-label" for="input-bank-account-name"><?php echo $entry_bank_account_name; ?></label>
					  <div class="col-md-9">
					...
					<div class="form-group">
					  <label class="col-md-3 control-label" for="input-bank-account-number"><?php echo $entry_bank_account_number; ?></label>
					  <div class="col-md-9">
				...
				<fieldset>
				  ...
				  <div class="form-group required">
					<label class="col-md-3 control-label" for="input-password"><?php echo $entry_password; ?></label>
					<div class="col-md-9">
				  ...
				  <div class="form-group required">
					<label class="col-md-3 control-label" for="input-confirm"><?php echo $entry_confirm; ?></label>
					<div class="col-md-9">
