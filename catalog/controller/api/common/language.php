<?php
class ControllerAPICommonLanguage extends Controller {
	...
	public function language() {
		if (isset($this->request->post['code'])) {
			...
			$this->model_account_customer->updateLanguage($this->request->post['code'],$customer_id);
			$json['success'] = 'Language updated';
			$json['status'] = 1;
		}else{
			$json['error'] = 'please select language code';
			$json['status'] = 0;
		}
