...
class ControllerAccountWishList extends Controller {
	public function index() {
		...
		$data['nav_text_wishlist'] = $this->language->get('nav_text_wishlist');
	...
	public function add() {
		...
		if ($product_info) {
			if ($this->customer->isLogged()) {
				...
				$res = $this->model_account_wishlist->getWishlist($this->request->post['product_id']);
				if($res){
					$json['warning'] = sprintf($this->language->get('text_error'), $this->url->link('product/product', 'product_id=' . (int)$this->request->post['product_id']), $product_info['name'], $this->url->link('account/wishlist'));
				}else{
