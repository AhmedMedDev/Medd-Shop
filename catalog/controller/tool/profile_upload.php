<?php
class ControllerToolProfileUpload extends Controller {
	public function index() {
		
		if (!$this->customer->isLogged()) {
			$json = array();
			$json['profile'] = false;
			$json['success'] = $this->url->link('account/login', '', 'SSL');
			...
			if (!$json) {
				...
				$result = $this->model_tool_profile_upload->addUpload('',$newfilename);
				$json['profile'] = false;
				if($result!=false){
