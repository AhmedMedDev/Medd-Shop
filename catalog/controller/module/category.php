		...
		foreach ($categories_1 as $category_1) {
			...
			foreach ($categories_2 as $category_2) {
				...
				foreach ($categories_3 as $category_3) {
					$filter_data = array('filter_category_id' => $category_3['category_id'], 'filter_sub_category' => false);
					$level_3_data[] = array(
				...
				$filter_data = array('filter_category_id' => $category_2['category_id'], 'filter_sub_category' => false);
				$level_2_data[] = array(
