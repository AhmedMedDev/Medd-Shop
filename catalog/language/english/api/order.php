...
$_['error_stock']            = 'Warning: Products marked with *** are not available in the desired quantity or not in stock! <a id="request_quote" onclick="getProductQuote(\'\',6)">Request a Quote</a>';
