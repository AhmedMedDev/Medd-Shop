...
$_['error_model']        = 'Product Code must be greater than 3 and less than 64 characters!';
$_['error_reason']       = 'You must select a return product reason!';
$_['error_agree']        = 'Warning: You must agree to the %s!';
$_['error_return_status']= 'Order must be in "%s" status for return request.';
$_['error_return_already_placed']= 'Return request for this product already placed';
