...
$_['text_empty']        = '<h3>There is no product that matches the search criteria.</h3> <p>Does not found what you are looking for? <a id="request_quote" onclick="getProductQuote(\'\', 2)">Click here</a> to submit your request now.</a></p>';
$_['text_quantity']     = 'Qty:';
