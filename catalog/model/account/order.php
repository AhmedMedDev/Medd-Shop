...
class ModelAccountOrder extends Model {
	...
	public function getOrderStatus($order_status_id = '') {
		$queryStr = "SELECT * FROM " . DB_PREFIX . "order_status WHERE ";
		
		if($order_status_id !== ''){
			$queryStr .= "order_status_id = '" . (int)$order_status_id . "' AND ";
		}		
		$queryStr .= "language_id = '" . (int)$this->config->get('config_language_id') . "'";
		 
		$query = $this->db->query($queryStr);
		
		foreach ($query->rows as $result) {
			$order_status_data[$result['order_status_id']] = $result['name'];
		}
