<?php
class ModelAPIAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$message_to_customer =  nl2br($message_to_customer);
	...
	public function getActivatedCurrency($customer_id) {
		$query = $this->db->query("SELECT currency FROM " . DB_PREFIX . "customer WHERE customer_id = '" . (int)$customer_id . "'");
